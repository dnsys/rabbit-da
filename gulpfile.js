...
gulp.task('styles:application', function () {
    return gulp.src(
            ...
            [
                paths.styles.input,
                styles + 'app-theme-legacy.sass',
                styles + 'app-theme-carrot.sass',
                styles + 'app-theme-spring.sass',
            ]
        )
...
gulp.task('watch', ['browserSync'], function() {
    ...
    gulp.watch(["*.php", '/includes/**/*.php'], browserSync.reload);
